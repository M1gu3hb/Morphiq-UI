...
const DEPTH = {
  ...
  skeuo: {
    // A cooler machined recess: hard top bevel, achromatic shade and tight
    // contact shadow distinguish it from clay's diffuse warm body.
    rest: "shadow-[inset_0_1px_0_rgba(255,255,255,0.94),inset_0_-3px_5px_rgba(30,34,38,0.15),inset_0_0_0_rgba(30,34,38,0),0_2px_0_var(--mq-edge,#a4a9ae),0_5px_10px_rgba(38,43,48,0.20)]",
    hover:
      "hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.99),inset_0_-3px_5px_rgba(30,34,38,0.17),inset_0_0_0_rgba(30,34,38,0),0_3px_0_var(--mq-edge,#a4a9ae),0_8px_15px_rgba(38,43,48,0.25)]",
    focus:
      "focus-visible:shadow-[inset_0_1px_0_rgba(255,255,255,0.70),inset_0_-2px_4px_rgba(30,34,38,0.10),inset_0_5px_11px_rgba(30,34,38,0.32),0_1px_0_var(--mq-edge,#a4a9ae),0_2px_3px_rgba(38,43,48,0.15)] " +
      "data-[focus=true]:shadow-[inset_0_1px_0_rgba(255,255,255,0.70),inset_0_-2px_4px_rgba(30,34,38,0.10),inset_0_5px_11px_rgba(30,34,38,0.32),0_1px_0_var(--mq-edge,#a4a9ae),0_2px_3px_rgba(38,43,48,0.15)]",
  },
  adaptive: {
